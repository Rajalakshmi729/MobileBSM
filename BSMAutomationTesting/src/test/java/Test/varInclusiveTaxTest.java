...
public class varInclusiveTaxTest extends BaseTest {

	String filename = "C:\\Users\\Robin\\eclipse-workspace\\BSMAutomationTesting\\TestData\\AddSaleForVarInclusiveTax.xlsx";
	...
	Thread.sleep(2000);
	vit.orderSummaryCalcInclusive(testData);

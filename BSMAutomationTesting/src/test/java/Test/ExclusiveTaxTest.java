...
public class ExclusiveTaxTest extends BaseTest {
	String filename = "C:\\Users\\Robin\\eclipse-workspace\\BSMAutomationTesting\\TestData\\AddSaleForExclusiveTax.xlsx";
	...
	Thread.sleep(2000);
	ETS.orderSummaryCalcExclusive(testData);
